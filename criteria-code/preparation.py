...
def get_mapping_from_criterion(criterion):
    ...
    print('http://141.76.60.253:3000/concepts/search.json?search='+str_criterion[1:])
    mapping = requests.get('http://141.76.60.253:3000/concepts/search.json?search='+str_criterion[1:])
