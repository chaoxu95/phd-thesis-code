...
def get_all_superclasses(snomedid):
    ...
    #print(data)
    #superclasses = requests.post('http://141.76.60.253:8080', data = data)
    superclasses = requests.post('http://localhost:8080', data = data)
...
def get_synset_of_concept(snomedid):
    ...
    url = 'http://141.76.60.253:3000/concepts/'+snomedid+'/labels.json'
    return_str = requests.get(url)
    #print(return_str.status_code)
